...
(let* ((bg "#111416")
      ...
      (tertiary "#d1bfe7")
      (tertiary-container "#4e4162")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#d1bfe7")
      (on-success "#372a4a")
      (success-container "#4e4162")
      (on-success-container "#eddcff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#92ccff")
      (primary-fixed-dim "#004b73")
      (secondary-fixed "#b8c8da")
      (secondary-fixed-dim "#394857")
      (tertiary-fixed "#d1bfe7")
      (tertiary-fixed-dim "#4e4162")
      (on-primary-fixed "#003351")
      (on-primary-fixed-variant "#cce5ff")
      (on-secondary-fixed "#23323f")
      (on-secondary-fixed-variant "#d4e4f6")
      (on-tertiary-fixed "#372a4a")
      (on-tertiary-fixed-variant "#eddcff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e2e5")
      (inverse-primary "#92ccff")
      (inverse-surface "#111416")
